...
def train(data_folder, save_path):
    ...
    for epoch in range(nr_epochs):
        ...
        epoch_losses.append(avg_loss.cpu().item())  # Record the average loss for this epoch
...
def cross_entropy_loss(batch_out, batch_gt):
    ...
    if batch_gt.ndim == 2 and batch_gt.size(1) > 1:
        batch_gt = torch.argmax(batch_gt, dim=1)
...
if __name__ == "__main__":
    ...
    parser.add_argument('-s', '--save_path', default="C:/Users/bcerv/OneDrive/Documents/Robot Learning/Robot_Learning_Hw1/Trained Model.pt", type=str, help='C:/Users/bcerv/OneDrive/Documents/Robot Learning/Robot_Learning_Hw1/Trained Model.pt')
